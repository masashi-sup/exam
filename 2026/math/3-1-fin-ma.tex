...
nombre={\Large{$\smash{\raisebox{-0.5\zh}{\href{https://fanme.link/@masashi\_00\_}{\includegraphics[width=2\zw]{../../common/icon-masashi.png}}}}$ 中学３年 数学 １学期期末対策 模範解答\quad\textrm{No.~\thepage}}},
...
\pbox*{1}
\ptxt{1}{c}{\includegraphics[width=0.8\linewidth]{fig/証明/3-1-f-1.pdf}}
\end{ansbox}

\begin{ansbox}[height=90mm]
\pbox*{1}
\ptxt{1}{c}{\includegraphics[width=0.8\linewidth]{fig/証明/3-1-f-2.pdf}}
\end{ansbox}

\vfill
\hfill{}まさしの情報はここからチェック → \href{https://fanme.link/@masashi\_00\_}{\includegraphics[width=3\zw]{../../common/qr-fanme.png}}
\newpage
