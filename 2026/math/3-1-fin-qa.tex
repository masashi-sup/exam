...
nombre={\Large{$\smash{\raisebox{-0.5\zh}{\href{https://fanme.link/@masashi\_00\_}{\includegraphics[width=2\zw]{../../common/icon-masashi.png}}}}$ 中学３年 数学 １学期期末対策 問題用紙\quad\textrm{No.~\thepage}}},
...
\NewPageStyle{examA}
{nombre_position=top-left,
nombre={\Large{$\smash{\raisebox{-0.5\zh}{\href{https://fanme.link/@masashi\_00\_}{\includegraphics[width=2\zw]{../../common/icon-masashi.png}}}}$ 中学３年 数学 １学期期末対策 解答用紙\quad\textrm{No.~\thepage}}},
running_head_position=top-right,
odd_running_head=\normalsize{\textrm{３年\underline{\hspace{2\zw}}組\underline{\hspace{2\zw}}番
\hspace{0.5\zw}氏名\underline{\hspace{15\zw}}}}}
